...
def test_html_receipt_quantity_is_integer_safe():
    ...
    html = receipt_html(Sale(), [{"name": "ROKO", "quantity": Decimal("1.0"), "unit_price": Decimal("30000"), "line_total": Decimal("30000")}], {"store_name": "TOKO SAPNI", "store_address": "Jl. Ciawitali No 07", "store_phone": "0851", "receipt_footer": "Terima kasih"})
